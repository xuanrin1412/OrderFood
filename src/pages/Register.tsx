            ...
            <div className=" mt-[3.313em] lg:ml-28 xl:ml-[10.313rem]">
                ...
                <div className="lg:max-w-[28.125rem] xl:max-w-[33.75rem] mt-12 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <span className={`h-58 flex items-center pt-[1.188rem] pb-[1.125rem] rounded-xl border ${focusedField === 'username' ? 'border-red-500' : 'border-borderColor'} dark:border-borderColorDark`}
                        ...
                        <span className="h-58 flex items-center pt-[1.188rem] pb-[1.125rem] rounded-xl border border-borderColor  dark:border-borderColorDark">
                            <HiOutlineMail style={{ height: 24, width: 24, marginLeft: 16, marginRight: 12, color: "#96A0B5" }} />
                            <input type="email" required placeholder="Email" className="stylePlaceholder flex-1 mr-[2.688rem] outline-none text-base leading-nomalText font-medium tracking-nomalText text-textInput dark:text-white bg-white dark:bg-[#292C38]  " />
                        </span>
                        <span className="h-58 flex items-center pt-[1.188rem] pb-[1.125rem] rounded-xl border border-borderColor  dark:border-borderColorDark">
                    ...
                    <div className="flex items-center custom-checkbox">
                        ...
                        <span className=" text-textsecondary dark:text-textMain font-medium text-base leading-nomalText">I agree to the Terms & Conditions</span>
                    </div>
                    <button className="h-58  bg-third text-base leading-nomalText tracking-nomalText font-medium rounded-xl text-white ">Sign Up</button>
                    <div className="divider">
                        <div className="divider-content text-textsecondary dark:text-textMain  font-medium text-sm px-4">Or sign up with</div>
                    </div>
                ...
                <div className="lg:max-w-[28.125rem] xl:max-w-[33.75rem]  pt-[8.313rem] pb-12 flex justify-center">
                    ...
                    <span className="text-third font-bold text-base">Log In</span>
                </div>
